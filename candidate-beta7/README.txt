Megabonk Deck beta 7 - test candidate

Leaves cursor ownership with the native main menu so controller input works
immediately after launch. The user verified cold-launch D-pad navigation down to
Together, back up, and A activation on a physical Deck without mouse intervention.
Keeps beta 6 modal focus, visible gold selection, character-menu handoff, and the
earlier hover and room-code layout fixes. Two-player joining, match start,
extended play, a fresh physical installation, and the built-in STEAM+X keyboard
remain unverified.

EXISTING Together installation (official Proton 5.1.0 or Deck beta 1-6):
1. Switch to Desktop Mode and close Megabonk. Steam can stay open.
2. Extract the WHOLE megabonk-deck-beta7-test.zip archive in Downloads.
3. Open the extracted folder and double-click Test-Deck-Beta7.desktop.
...
4. Confirm the update. Launch Megabonk in Gaming Mode and check Deck beta 7.
...
4. After the original installer succeeds, double-click Test-Deck-Beta7.desktop
   in the same folder. Confirm the update, then launch the game in Gaming Mode.
5. Check that the menu says Deck beta 7.
...
restore launchers do not recognize the beta 7 DLL.
...
megabonk-deck-beta7-source.zip contains the matching modified mod source and
